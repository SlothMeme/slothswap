...
export const lightColors = {
  ...
  textSubtle: '#7A6EAA',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(180deg, rgb(227 202 133) 0%, rgb(211 211 211) 65%)',
...
export const darkColors = {
  ...baseColors,
  ...additionalColors,
  secondary: '#b37704', // some text
  secondary80: '#9A6AFF80',
  background: '#08060B',
  backgroundDisabled: '#423737',
  backgroundAlt: '#474747', // headersBG
  backgroundAlt2: 'rgba(39, 38, 44, 0.7)',
  cardBorder: '#ffffff', // frames line
  contrast: '#FFFFFF',
  dropdown: '#1E1D20',
  dropdownDeep: '#100C18',
  ...
  textSubtle: '#a8a8a8',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(180deg, rgba(70,70,70,1) 0%, rgba(43,43,43,1) 65%)', // mainBG
